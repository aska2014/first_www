...
class MimeType {
    ...
    public static function getMimeType($path)
    {
        ...
        return isset($mimeTypes[$extension]) ? $mimeTypes[$extension] : ''; // return the array value
    }
    ...
    public static function isDoc($path)
    {
        $mimeType = static::getMimeType($path);

        return in_array($mimeType, ['application/msword']);
    }

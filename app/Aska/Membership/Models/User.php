<?php namespace Aska\Membership\Models;
...
class User extends BaseModel implements UserInterface, RemindableInterface {
    ...
    {
        return URL::asset('albums/profile/user'.$this->id.'.jpg');
    }
    ...
    {
        return $this->hasMany(Project::getClass(), 'approved_by_id');
    }
    ...
    {
        return $this->hasMany(Project::getClass(), 'created_by_id');
    }
    ...
    {
        return $this->hasManyThrough(File::getClass(), Drive::getClass(), 'user_id', 'drive_id');
    }
    ...
    {
        return $this->hasMany(Drive::getClass(), 'user_id');
    }
    ...
    {
        return $this->belongsToMany(Department::getClass(), 'user_department', 'user_id', 'department_id');
    }
    ...
    {
        return $this->belongsToMany(Project::getClass(), 'project_user', 'user_id', 'project_id');
    }
    ...
    {
        return $this->hasMany(ProjectComment::getClass(), 'user_id');
    }
    ...
    {
        return $this->hasMany(Notification::getClass(), 'user_id');
    }
}

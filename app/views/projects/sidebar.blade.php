...
<!--                    </li>-->
<!--                    <li class="media"> <a href="#" class="media-photo" style="background-image:url(images/portfolio/b3.jpg)"></a> <a href="#" class="media-date">17<span>FEB</span></a>-->
<!--                        <h5 class="media-heading"><a href="#">Media heading, this is a title of a news...</a></h5>-->
<!--                        <p>Fugiat dapibus, tellus ac cursus commodo, ut fermentum...</p>-->
<!--                    </li>-->
<!--                    <li class="media"> <a href="#" class="media-photo" style="background-image:url(images/portfolio/b4.jpg)"></a> <a href="#" class="media-date">16<span>FEB</span></a>-->
<!--                        <h5 class="media-heading"><a href="#">Media heading, of a news item.</a></h5>-->
<!--                        <p>Fugiat dapibus, tellus ac cursus commodo, condime ntum nibh, ut fermentum...</p>-->
<!--                    </li>-->
<!--                </ul>-->
